  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item active  ml-5">
        <a class="nav-link text-color" href="register"><b><span class="text-color">Register</span></b></a>
      </li>
       <li class="nav-item active  ml-5">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonee.png" style="width:27px;" alt="img">+91 9673251683<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">dhananjaythube08@gmail.com
            </b>
        </p>
        </div>
      </div>
